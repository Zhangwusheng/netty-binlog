...
import com.zhangwusheng.binlog.event.data.XidEventData;
...
public class XidEventDataDeserializer implements EventDataDeserializer<XidEventData> {
    ...
    public XidEventData deserialize(ByteBuf inputStream)  {
        XidEventData eventData = new XidEventData();
//        eventData.setXid(inputStream.readLong(8));
        eventData.setXid(ByteUtil.readUnsignedLong(inputStream,8));
        return eventData;
    }
}
